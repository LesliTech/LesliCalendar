...
module CloudDriver
  class Event::AttachmentsTest < ApplicationSystemTestCase
    setup do
      @event_attachment = cloud_driver_event_attachments(:one)
    end

    test "visiting the index" do
      visit event_attachments_url
      assert_selector "h1", text: "Event/Attachments"
    end

    test "creating a Attachment" do
      visit event_attachments_url
      click_on "New Event/Attachment"
